...
export function ProductHero({
  ...
  ctaLabel = 'Explore',
  ctaHref = '/contact',
  accentColor = 'rgba(139,92,246,0.07)',
}: ProductHeroProps) {
  return (
    <section className="relative min-h-[60vh] md:min-h-[75vh] flex items-center justify-start overflow-hidden py-20 md:py-32">
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 40% at 50% 50%, rgba(255,255,255,0.008) 0%, transparent 65%)',
          filter: 'blur(60px)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to bottom, transparent 0%, rgba(8,10,18,0.6) 60%, rgba(12,14,24,1) 100%)',
        }}
      />
