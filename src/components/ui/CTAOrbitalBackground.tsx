...
<linearGradient id="cta-orbit-line" x1="0" y1="0" x2="1600" y2="0">
  ...
  <stop offset="100%" stopColor="#9A5CFF" stopOpacity="0" />
        ...
        {/* main orbit system — flatter and lower */}
        <ellipse
          cx="800"
          cy="168"
          rx="560"
        ...
        <circle cx="800" cy="104" r="22" fill="url(#cta-violet-glow)" opacity="0.44" />

        <circle cx="420" cy="172" r="2.6" fill="#9A5CFF" opacity="0.62" />
        <circle cx="420" cy="172" r="20" fill="url(#cta-violet-glow)" opacity="0.34" />

        <circle cx="1180" cy="158" r="2.8" fill="#9A5CFF" opacity="0.66" />
        <circle cx="1180" cy="158" r="24" fill="url(#cta-violet-glow)" opacity="0.36" />

        <circle cx="676" cy="222" r="2.3" fill="#6AF6FF" opacity="0.48" />
        <circle cx="676" cy="222" r="20" fill="url(#cta-cobalt-glow)" opacity="0.26" />
      </svg>
    </div>
  );
}