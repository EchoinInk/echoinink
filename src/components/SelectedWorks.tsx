...
const works = [
  {
    ...
    gradient:
      'radial-gradient(ellipse 70% 65% at 38% 55%, rgb(221, 18, 203 / 0.28) 0%, rgb(113, 7, 234 / 0.16) 32%, rgb(11, 13, 42 / 0.07) 62%, transparent 82%), radial-gradient(ellipse 40% 50% at 75% 30%, rgb(73, 133, 253 / 0.10) 0%, transparent 65%)',
    bg: 'var(--ei-void)',
    scene:
      'radial-gradient(ellipse 22% 50% at 68% 30%, rgb(var(--ei-ice-white-rgb) / 0.07) 0%, transparent 65%), radial-gradient(ellipse 30% 25% at 18% 82%, rgb(227, 216, 253 / 0.07) 0%, transparent 60%)',
  },
  {
    index: '02',
    ...
    gradient:
      'radial-gradient(ellipse 65% 72% at 58% 42%, rgb(73, 133, 253 / 0.22) 0%, rgb(11, 13, 42 / 0.12) 42%, transparent 72%)',
    bg: 'var(--ei-void)',
    scene:
      'linear-gradient(172deg, rgb(73, 133, 253 / 0.08) 0%, transparent 38%), radial-gradient(ellipse 16% 62% at 56% 8%, rgb(227, 216, 253 / 0.07) 0%, transparent 70%)',
  },
  {
    index: '03',
    ...
    gradient:
      'radial-gradient(ellipse 68% 60% at 42% 60%, rgb(113, 7, 234 / 0.24) 0%, rgb(11, 13, 42 / 0.12) 45%, transparent 88%)',
    bg: 'var(--ei-void)',
    scene:
      'radial-gradient(circle at 22% 28%, rgb(227, 216, 253 / 0.06) 0%, transparent 28%), radial-gradient(circle at 74% 62%, rgb(227, 216, 253 / 0.05) 0%, transparent 24%), radial-gradient(circle at 85% 20%, rgb(227, 216, 253 / 0.04) 0%, transparent 18%)',
  },
  {
    index: '04',
    title: 'Signal / Memory',
    ...
    description:
      ...
      gradient:
        'radial-gradient(ellipse 55% 70% at 62% 38%, rgb(73, 133, 253 / 0.20) 0%, rgb(11, 13, 42 / 0.12) 40%, transparent 70%), radial-gradient(ellipse 45% 45% at 18% 72%, rgb(221, 18, 203 / 0.12) 0%, transparent 62%)',
      bg: 'var(--ei-void)',
      scene:
        'repeating-linear-gradient(90deg, transparent, transparent 48px, rgb(73, 133, 253 / 0.013) 48px, rgb(73, 133, 253 / 0.013) 49px), linear-gradient(118deg, transparent 28%, rgb(var(--ei-ice-white-rgb) / 0.04) 44%, transparent 62%)',
  },
  {
    index: '05',
    ...
    description:
      ...
      gradient:
        'radial-gradient(ellipse 72% 65% at 44% 52%, rgb(221, 18, 203 / 0.20) 0%, rgb(113, 7, 234 / 0.11) 42%, transparent 86%)',
      bg: 'var(--ei-void)',
      scene:
        'radial-gradient(ellipse 38% 28% at 22% 72%, rgb(227, 216, 253 / 0.08) 0%, transparent 60%), radial-gradient(ellipse 25% 35% at 82% 22%, rgb(227, 216, 253 / 0.07) 0%, transparent 55%)',
  },
  {
    index: '06',
    ...
    description:
      ...
      gradient:
        'radial-gradient(ellipse 58% 74% at 52% 44%, rgb(var(--ei-ice-white-rgb) / 0.07) 0%, rgb(227, 216, 253 / 0.14) 25%, rgb(113, 7, 234 / 0.18) 50%, rgb(11, 13, 42 / 0.08) 72%, transparent 88%)',
      bg: 'var(--ei-void)',
      scene:
        'linear-gradient(78deg, transparent 18%, rgb(227, 216, 253 / 0.06) 36%, rgb(113, 7, 234 / 0.04) 52%, transparent 68%), linear-gradient(78deg, transparent 42%, rgb(227, 216, 253 / 0.04) 58%, transparent 74%)',
  },
] as const;
...
function WorkPanel({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 transition-transform duration-1000 ease-out group-hover:scale-[1.015]"
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 85% 85% at 50% 50%, transparent 30%, rgb(5, 3, 11 / 0.65) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          height: isFull ? '60%' : '72%',
          background: 'linear-gradient(to bottom, transparent, rgb(5, 3, 11 / 0.92) 100%)',
        }}
      />
  ...
  return (
    <section className="relative ei-section py-16 md:py-32 overflow-hidden">
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse 60% 70% at 50% 50%, rgb(11, 13, 42 / 0.012) 0%, transparent 75%)',
        }}
      />
      {/* Section header */}
