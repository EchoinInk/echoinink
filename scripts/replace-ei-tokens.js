...
const replacements = [
  ...
  ['--ei-midnight-rgb', '--ei-midnight-rgb'],
  ['--ei-electric-blue-rgb', '--ei-electric-blue-rgb'],
  ['--ei-echo-magenta-rgb', '--ei-echo-magenta-rgb'],
  ['--ei-soft-neon-rgb', '--ei-soft-neon-rgb'],
  ['--ei-moonlit-rgb', '--ei-moonlit-rgb'],
  ['--ei-midnight-rgb', '--ei-midnight-rgb'],
  ['--ei-void-rgb', '--ei-void-rgb'],
  ['--ei-ice-white-rgb', '--ei-ice-white-rgb'],
  ['--ei-midnight', '--ei-midnight'],
  ['--ei-midnight', '--ei-midnight'],
  ['--ei-electric-blue', '--ei-electric-blue'],
  ['--ei-echo-magenta', '--ei-echo-magenta'],
  ['--ei-soft-neon', '--ei-soft-neon'],
  ['--ei-moonlit', '--ei-moonlit'],
  ['--ei-midnight', '--ei-midnight'],
  ['--ei-void', '--ei-void'],
