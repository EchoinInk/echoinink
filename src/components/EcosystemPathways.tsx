...
const layers = [
  ...
  },
  {
    ...
    accentLine: 'rgba(56,189,248,0.35)',
    tag: '02',
  },
  {
    to: '/lumo',
    ...
    accentLine: 'rgba(232,121,249,0.4)',
    tag: '03',
  },
];
  ...
  return (
    <Section spacing="sm" className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 65% 40% at 50% 50%, rgba(99,102,241,0.03) 0%, transparent 65%)',
          filter: 'blur(70px)',
        }}
      />
            ...
            {layers.map((layer) => (
              <motion.div key={layer.label} variants={driftUp}>
                <Link
                  ...
                  style={{
                    background: `radial-gradient(ellipse 80% 100% at 0% 50%, ${layer.accent} 0%, transparent 55%), rgba(255,255,255,0.025)`,
