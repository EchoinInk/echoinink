      ...
      >
        ...
        >
          <img
            ...
            alt=""
            aria-hidden="true"
            className="ei-project-card-image absolute inset-0 h-full w-full object-cover object-[57%_50%] transition-transform duration-700 [transition-timing-function:cubic-bezier(0.22,_1,_0.36,_1)] group-hover:scale-[1.02] motion-reduce:transition-none motion-reduce:group-hover:scale-100"
          />
  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        aria-hidden="true"
        className="ei-project-card-image absolute inset-0 h-full w-full object-cover object-center transition-transform duration-700 [transition-timing-function:cubic-bezier(0.22,_1,_0.36,_1)] group-hover:scale-[1.02] motion-reduce:transition-none motion-reduce:group-hover:scale-100"
      />
