    ...
    <div ref={wrapperRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className="
          ...
          bg-[linear-gradient(to_bottom,rgb(var(--ei-midnight-rgb)/0.24),rgb(var(--ei-void-rgb)/0.80))]
      ...
      {isOpen && (
        <ul
          ...
          className="
            ...
            bg-[linear-gradient(to_bottom,rgb(var(--ei-midnight-rgb)/0.96),rgb(var(--ei-void-rgb)/0.98))]
            p-2
