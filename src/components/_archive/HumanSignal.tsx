  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 55% 45% at 50% 50%, rgb(221, 18, 203 / 0.03) 0%, rgb(227, 216, 253 / 0.02) 40%, transparent 70%)',
          filter: 'blur(80px)',
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to bottom, rgb(11, 13, 42 / 0.5) 0%, transparent 100%)',
        }}
      />
      <div
        className="absolute inset-x-0 bottom-0 h-20 pointer-events-none"
        style={{
          background: 'linear-gradient(to top, rgb(11, 13, 42 / 0.5) 0%, transparent 100%)',
        }}
      />
    </section>
  );
