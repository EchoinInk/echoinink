...
export function OrbitalVisual({
  ...
  const icons: Record<OrbitalVariant, React.ReactElement> = {
    ...
    orbit: (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
        <circle cx={c} cy={c} r={r} stroke={strokeDim} strokeWidth="1.0" />
        <ellipse cx={c} cy={c} rx={r - 4} ry={(r - 4) * 0.42} stroke={strokeLight} strokeWidth="1.5" />
    ...
    nodes: (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
        <circle cx={c} cy={c} r={r} stroke={strokeDim} strokeWidth="1.0" />
        <line x1={c} y1={11} x2={11} y2={size - 11} stroke={strokeLight} strokeWidth="1.0" />
        <line x1={c} y1={11} x2={size - 11} y2={size - 11} stroke={strokeLight} strokeWidth="1.0" />
        <line x1={11} y1={size - 11} x2={size - 11} y2={size - 11} stroke={strokeLight} strokeWidth="1.0" />
    ...
    compass: (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
        <circle cx={c} cy={c} r={r} stroke={strokeDim} strokeWidth="1.0" />
        <circle cx={c} cy={c} r={r - 9} stroke={strokeLight} strokeWidth="1.5" />
    ...
    canvas: (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
        <circle cx={c} cy={c} r={r} stroke={strokeDim} strokeWidth="1.0" />
        <circle cx={c} cy={c} r={r - 9} stroke={strokeLight} strokeWidth="1.0" />
        <ellipse
          cx={c} cy={c}
          rx={r - 9} ry={(r - 9) * 0.48}
    ...
    reflection: (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
        <circle cx={c} cy={c} r={r} stroke={strokeDim} strokeWidth="1.0" />
        <line x1={c} y1={9} x2={c} y2={size - 9} stroke={strokeLight} strokeWidth="1.5" />
        <line x1={9} y1={c} x2={size - 9} y2={c} stroke={strokeLight} strokeWidth="1.5" />
    ...
    architect: (
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
        <circle cx={c} cy={c} r={r} stroke={strokeDim} strokeWidth="1.0" />
        <ellipse cx={c} cy={c} rx={r - 5} ry={(r - 5) * 0.38} stroke={strokeLight} strokeWidth="1.5" />
        <ellipse
          cx={c} cy={c}
          rx={r - 5} ry={(r - 5) * 0.38}
          stroke={strokeDim} strokeWidth="0.9"
