  ...
  return (
    <div ref={ref} className={`relative h-[60vh] flex items-center justify-center overflow-hidden ${className}`}>
      ...
      <motion.div
        ...
        style={{
          background: `
            radial-gradient(ellipse 60% 50% at 50% 50%, rgb(113, 7, 234 / 0.04) 0%, transparent 60%),
            radial-gradient(ellipse 40% 40% at 50% 50%, rgb(221, 18, 203 / 0.03) 0%, transparent 50%)
          `,
          filter: 'blur(60px)',
        }}
      />
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="eiGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="50%" stopColor="rgb(221, 18, 203 / 0.4)" />
              <stop offset="100%" stopColor="rgb(113, 7, 234 / 0.3)" />
            </linearGradient>
          </defs>
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(ellipse 50% 50% at 50% 50%, rgb(221, 18, 203 / 0.15) 0%, transparent 70%)',
            filter: 'blur(30px)',
          }}
        />
      </motion.div>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to top, rgb(11, 13, 42 / 0.8) 0%, transparent 100%)',
        }}
      />
    </div>
  );
    ...
    <div ref={ref} className={`relative ${className}`}>
      ...
      {!prefersReduced && (
        <motion.div
          ...
          style={{
            background: 'radial-gradient(ellipse 80% 80% at 50% 50%, rgb(11, 13, 42 / 0.95) 0%, rgb(11, 13, 42 / 0.7) 40%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
      )}
