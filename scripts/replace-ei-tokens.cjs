...
const replacements = [
  ...
  ['--ei-ion-violet-rgb', '--ei-echo-magenta-rgb'],
  ['--ei-neon-magenta-rgb', '--ei-soft-neon-rgb'],
  ['--ei-stellar-lilac-rgb', '--ei-moonlit-rgb'],
  ...
  ['--ei-ion-violet', '--ei-echo-magenta'],
  ['--ei-neon-magenta', '--ei-soft-neon'],
  ['--ei-stellar-lilac', '--ei-moonlit'],
