    ...
    <PageShell atmosphere="default" withTopSpacing={false}>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 42% 34% at 28% 18%, rgb(var(--ei-midnight-rgb) / 0.22) 0%, transparent 68%), radial-gradient(ellipse 34% 28% at 77% 16%, rgb(var(--ei-violet-rgb) / 0.07) 0%, transparent 72%), radial-gradient(ellipse 52% 38% at 50% 58%, rgb(var(--ei-halo-blue-rgb) / 0.035) 0%, transparent 70%)',
          }}
        />
        <div
...
>
  ...
  <div
    ...
    style={{
      background:
        'radial-gradient(ellipse 54% 65% at 20% 50%, rgb(var(--ei-midnight-rgb) / 0.18) 0%, transparent 70%), radial-gradient(ellipse 42% 48% at 72% 45%, rgb(var(--ei-violet-rgb) / 0.12) 0%, transparent 68%)',
    }}
  />
