  ...
  return (
    <Section spacing="sm" className="relative overflow-hidden py-8 md:py-10">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 60% 30% at 50% 50%, rgb(11, 13, 42 / 0.02) 0%, transparent 60%)',
          filter: 'blur(60px)',
        }}
      />
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <motion.div variants={driftUp} className="text-center mb-8">
              <span className="font-structural text-[10px] tracking-[0.22em] uppercase text-[var(--ei-color-text-secondary)]">
            </span>
          </motion.div>
          ...
          >
            {projectTypes.map((type, i) => (
              ...
              >
                <span className="font-structural text-[12px] md:text-[13px] tracking-[0.1em] uppercase text-[var(--ei-color-text-secondary)] group-hover:text-[var(--ei-color-text-primary)] transition-colors duration-500 block">
                  {type.category}
                </span>
                <span className="font-editorial text-[12px] md:text-[13px] italic text-[var(--ei-color-text-tertiary)] group-hover:text-[var(--ei-color-text-secondary)] transition-colors duration-500 block mt-1">
                  {type.context}
                </span>
              </motion.div>
            ))}
          ...
          <motion.div
            ...
            style={{
              background: 'linear-gradient(90deg, transparent 0%, rgb(113, 7, 234 / 0.05) 30%, rgb(11, 13, 42 / 0.05) 70%, transparent 100%)',
            }}
          />
        </motion.div>
      </Container>
