  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at center, transparent 40%, rgba(0, 0, 10, 0.08) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at center, transparent 55%, rgba(0, 0, 10, 0.12) 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          height: '15vh',
          background:
            'linear-gradient(to bottom, rgba(0, 0, 10, 0.2) 0%, transparent 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          height: '35vh',
          background:
            'linear-gradient(to bottom, transparent, rgba(0, 0, 10, 0.15) 40%, rgba(0, 0, 10, 0.35) 70%, #000000 100%)',
        }}
      />
    </>
  );
