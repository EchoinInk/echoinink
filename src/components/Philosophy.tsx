  ...
  return (
    <Section spacing="sm" className="ei-section-standard overflow-hidden relative">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 30% at 30% 40%, rgb(var(--ei-soft-neon-rgb) / 0.018) 0%, transparent 60%)',
          filter: 'blur(50px)',
        }}
      />
  ...
  <motion.div className="mx-auto max-w-6xl"
        ...
        >
          ...
          >
            ...
            <div
              className="h-px w-10 shrink-0 rounded-full shadow-[0_0_12px_rgb(var(--ei-electric-blue-rgb)/0.75)]"
              style={{
                background:
