  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 72% 24%, rgb(var(--ei-echo-magenta-rgb) / 0.10) 0%, transparent 36%), radial-gradient(circle at 80% 38%, rgb(var(--ei-electric-blue-rgb) / 0.08) 0%, transparent 32%)',
        }}
      />
