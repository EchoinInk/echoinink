  ...
  return (
    <Section spacing="sm" className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
            background:
              'radial-gradient(ellipse 40% 50% at 50% 50%, rgb(var(--ei-echo-magenta-rgb) / 0.025) 0%, transparent 60%)',
          filter: 'blur(60px)',
        }}
      />
      ...
      <Container size="md">
        ...
        >
          ...
          <motion.div
            ...
            style={{
                background:
                  'linear-gradient(90deg, transparent 0%, rgb(var(--ei-ice-white-rgb) / 0.06) 20%, rgb(var(--ei-echo-magenta-rgb) / 0.12) 50%, rgb(var(--ei-ice-white-rgb) / 0.06) 80%, transparent 100%)',
            }}
          />
